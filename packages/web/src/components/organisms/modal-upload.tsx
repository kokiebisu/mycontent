  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen} defaultOpen>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <UploadModalContent jsonData={jsonData} onModalCloseClick={handleModalClose} />
      </DialogContent>
    </Dialog>
  );
};
...
export const UploadModalContent = ({ jsonData, onModalCloseClick }: UploadModalContentProps) => (
  <div>
    <DialogHeader>
    ...
    <DialogFooter>
      <Button variant="outline" onClick={onModalCloseClick}>
        Close
      </Button>
    </DialogFooter>
  </div>
