...
func (ec *executionContext) _Mutation_createContent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNContent2ᚖgithubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_contents(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*ent.Content)
	fc.Result = res
	return ec.marshalNContent2ᚕᚖgithubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNContent2githubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContent(ctx context.Context, sel ast.SelectionSet, v ent.Content) graphql.Marshaler {
	return ec._Content(ctx, sel, &v)
}

func (ec *executionContext) marshalNContent2ᚕᚖgithubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContentᚄ(ctx context.Context, sel ast.SelectionSet, v []*ent.Content) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNContent2ᚖgithubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNContent2ᚖgithubᚗcomᚋkokiebisuᚋmycontentᚋpackagesᚋcontentsᚋentᚐContent(ctx context.Context, sel ast.SelectionSet, v *ent.Content) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
