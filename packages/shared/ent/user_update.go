...
func (uu *UserUpdate) SetInterest(e enum.Interest) *UserUpdate {
	uu.mutation.SetInterest(e)
	return uu
}

// SetNillableInterest sets the "interest" field if the given value is not nil.
func (uu *UserUpdate) SetNillableInterest(e *enum.Interest) *UserUpdate {
	if e != nil {
		uu.SetInterest(*e)
	}
	return uu
...
// SetInterest sets the "interest" field.
func (uuo *UserUpdateOne) SetInterest(e enum.Interest) *UserUpdateOne {
	uuo.mutation.SetInterest(e)
	return uuo
}

// SetNillableInterest sets the "interest" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableInterest(e *enum.Interest) *UserUpdateOne {
	if e != nil {
		uuo.SetInterest(*e)
	}
	return uuo
