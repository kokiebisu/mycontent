...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Blog":
			resolverName, err := entityResolverNameForBlog(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Blog": %w`, err)
			}
			switch resolverName {
			...
			case "findBlogByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findBlogByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindBlogByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Blog": %w`, err)
				}
...
func entityResolverNameForBlog(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
