...
func InterestEQ(v Interest) predicate.Blog {
	return predicate.Blog(sql.FieldEQ(FieldInterest, v))
}

// InterestNEQ applies the NEQ predicate on the "interest" field.
func InterestNEQ(v Interest) predicate.Blog {
	return predicate.Blog(sql.FieldNEQ(FieldInterest, v))
}

// InterestIn applies the In predicate on the "interest" field.
func InterestIn(vs ...Interest) predicate.Blog {
	return predicate.Blog(sql.FieldIn(FieldInterest, vs...))
}

// InterestNotIn applies the NotIn predicate on the "interest" field.
func InterestNotIn(vs ...Interest) predicate.Blog {
	return predicate.Blog(sql.FieldNotIn(FieldInterest, vs...))
}
