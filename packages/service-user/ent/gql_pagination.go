...
var (
	...
	// UserOrderFieldInterest orders User by interest.
	UserOrderFieldInterest = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.Interest, nil
		},
		column: user.FieldInterest,
		toTerm: user.ByInterest,
		toCursor: func(u *User) Cursor {
			return Cursor{
				ID:    u.ID,
				Value: u.Interest,
	...
	// UserOrderFieldYearsOfExperience orders User by years_of_experience.
	UserOrderFieldYearsOfExperience = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.YearsOfExperience, nil
		},
		column: user.FieldYearsOfExperience,
		toTerm: user.ByYearsOfExperience,
		toCursor: func(u *User) Cursor {
			return Cursor{
				ID:    u.ID,
				Value: u.YearsOfExperience,
			}
		},
	}
)
...
func (f UserOrderField) String() string {
	...
	case UserOrderFieldUsername.column:
		str = "USERNAME"
	case UserOrderFieldPassword.column:
		str = "PASSWORD"
	case UserOrderFieldInterest.column:
		str = "INTEREST"
	case UserOrderFieldYearsOfExperience.column:
...
func (f *UserOrderField) UnmarshalGQL(v interface{}) error {
	...
	case "INTEREST":
		*f = *UserOrderFieldInterest
	case "YEARS_OF_EXPERIENCE":
		*f = *UserOrderFieldYearsOfExperience
	default:
