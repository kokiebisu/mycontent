...
func (u *UserQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "interest":
			if _, ok := fieldSeen[user.FieldInterest]; !ok {
				selectedFields = append(selectedFields, user.FieldInterest)
				fieldSeen[user.FieldInterest] = struct{}{}
			}
		case "yearsOfExperience":
			if _, ok := fieldSeen[user.FieldYearsOfExperience]; !ok {
				selectedFields = append(selectedFields, user.FieldYearsOfExperience)
				fieldSeen[user.FieldYearsOfExperience] = struct{}{}
			}
		case "createdAt":
